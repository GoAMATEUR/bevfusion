...
class BaseTransform(nn.Module):
    def __init__(
        ...
        use_points='lidar', 
        depth_input='scalar',
        height_expand=False, # MODIFIED, https://github.com/mit-han-lab/bevfusion/issues/478
        add_depth_features=False, # MODIFIED, https://github.com/mit-han-lab/bevfusion/issues/478
    ) -> None:
        super().__init__()
